...
function DAQmxCreateAOFuncGenChan(taskHandle, physicalChannel, nameToAssignToChannel, type, freq, amplitude, offset)
    ccall((:DAQmxCreateAOFuncGenChan, nidaqmx), int32, (TaskHandle, Ref{UInt8}, Ref{UInt8}, int32, float64, float64, float64), taskHandle, physicalChannel, nameToAssignToChannel, type, freq, amplitude, offset)
end
...
function DAQmxGet11601CalAdjustPoints(calHandle, adjustmentPoints, bufferSize)
    ccall((:DAQmxGet11601CalAdjustPoints, nidaqmx), int32, (CalHandle, Ref{float64}, uInt32), calHandle, adjustmentPoints, bufferSize)
end

function DAQmxAdjust11601Cal(calHandle, channelNames, value)
    ccall((:DAQmxAdjust11601Cal, nidaqmx), int32, (CalHandle, Ref{UInt8}, float64), calHandle, channelNames, value)
end
...
function DAQmxGet11605CalAdjustPoints(calHandle, adjustmentPoints, bufferSize)
    ccall((:DAQmxGet11605CalAdjustPoints, nidaqmx), int32, (CalHandle, Ref{float64}, uInt32), calHandle, adjustmentPoints, bufferSize)
end

function DAQmxAdjust11605Cal(calHandle, channelNames, value)
    ccall((:DAQmxAdjust11605Cal, nidaqmx), int32, (CalHandle, Ref{UInt8}, float64), calHandle, channelNames, value)
end
...
function DAQmxGet9252CalAdjustPoints(calHandle, adjustmentPoints, bufferSize)
    ccall((:DAQmxGet9252CalAdjustPoints, nidaqmx), int32, (CalHandle, Ref{float64}, uInt32), calHandle, adjustmentPoints, bufferSize)
end

function DAQmxAdjust9252Cal(calHandle, channelNames, value)
    ccall((:DAQmxAdjust9252Cal, nidaqmx), int32, (CalHandle, Ref{UInt8}, float64), calHandle, channelNames, value)
end

function DAQmxGet9253CalAdjustPoints(calHandle, adjustmentPoints, bufferSize)
    ccall((:DAQmxGet9253CalAdjustPoints, nidaqmx), int32, (CalHandle, Ref{float64}, uInt32), calHandle, adjustmentPoints, bufferSize)
end

function DAQmxAdjust9253Cal(calHandle, channelNames, value)
    ccall((:DAQmxAdjust9253Cal, nidaqmx), int32, (CalHandle, Ref{UInt8}, float64), calHandle, channelNames, value)
end
...
function DAQmxGet9262CalAdjustPoints(calHandle, adjustmentPoints, bufferSize)
    ccall((:DAQmxGet9262CalAdjustPoints, nidaqmx), int32, (CalHandle, Ref{int32}, uInt32), calHandle, adjustmentPoints, bufferSize)
end

function DAQmxSetup9262Cal(calHandle, channelNames, value)
    ccall((:DAQmxSetup9262Cal, nidaqmx), int32, (CalHandle, Ref{UInt8}, int32), calHandle, channelNames, value)
end

function DAQmxAdjust9262Cal(calHandle, channelNames, value)
    ccall((:DAQmxAdjust9262Cal, nidaqmx), int32, (CalHandle, Ref{UInt8}, float64), calHandle, channelNames, value)
end
...
function DAQmxGetAIInputLimitsFaultDetectUpperLimit(taskHandle, channel, data)
    ccall((:DAQmxGetAIInputLimitsFaultDetectUpperLimit, nidaqmx), int32, (TaskHandle, Ref{UInt8}, Ref{float64}), taskHandle, channel, data)
end

function DAQmxSetAIInputLimitsFaultDetectUpperLimit(taskHandle, channel, data)
    ccall((:DAQmxSetAIInputLimitsFaultDetectUpperLimit, nidaqmx), int32, (TaskHandle, Ref{UInt8}, float64), taskHandle, channel, data)
end

function DAQmxResetAIInputLimitsFaultDetectUpperLimit(taskHandle, channel)
    ccall((:DAQmxResetAIInputLimitsFaultDetectUpperLimit, nidaqmx), int32, (TaskHandle, Ref{UInt8}), taskHandle, channel)
end

function DAQmxGetAIInputLimitsFaultDetectLowerLimit(taskHandle, channel, data)
    ccall((:DAQmxGetAIInputLimitsFaultDetectLowerLimit, nidaqmx), int32, (TaskHandle, Ref{UInt8}, Ref{float64}), taskHandle, channel, data)
end

function DAQmxSetAIInputLimitsFaultDetectLowerLimit(taskHandle, channel, data)
    ccall((:DAQmxSetAIInputLimitsFaultDetectLowerLimit, nidaqmx), int32, (TaskHandle, Ref{UInt8}, float64), taskHandle, channel, data)
end

function DAQmxResetAIInputLimitsFaultDetectLowerLimit(taskHandle, channel)
    ccall((:DAQmxResetAIInputLimitsFaultDetectLowerLimit, nidaqmx), int32, (TaskHandle, Ref{UInt8}), taskHandle, channel)
end

function DAQmxGetAIInputLimitsFaultDetectEnable(taskHandle, channel, data)
    ccall((:DAQmxGetAIInputLimitsFaultDetectEnable, nidaqmx), int32, (TaskHandle, Ref{UInt8}, Ref{bool32}), taskHandle, channel, data)
end

function DAQmxSetAIInputLimitsFaultDetectEnable(taskHandle, channel, data)
    ccall((:DAQmxSetAIInputLimitsFaultDetectEnable, nidaqmx), int32, (TaskHandle, Ref{UInt8}, bool32), taskHandle, channel, data)
end

function DAQmxResetAIInputLimitsFaultDetectEnable(taskHandle, channel)
    ccall((:DAQmxResetAIInputLimitsFaultDetectEnable, nidaqmx), int32, (TaskHandle, Ref{UInt8}), taskHandle, channel)
end

function DAQmxGetAIPowerSupplyFaultDetectEnable(taskHandle, channel, data)
    ccall((:DAQmxGetAIPowerSupplyFaultDetectEnable, nidaqmx), int32, (TaskHandle, Ref{UInt8}, Ref{bool32}), taskHandle, channel, data)
end

function DAQmxSetAIPowerSupplyFaultDetectEnable(taskHandle, channel, data)
    ccall((:DAQmxSetAIPowerSupplyFaultDetectEnable, nidaqmx), int32, (TaskHandle, Ref{UInt8}, bool32), taskHandle, channel, data)
end

function DAQmxResetAIPowerSupplyFaultDetectEnable(taskHandle, channel)
    ccall((:DAQmxResetAIPowerSupplyFaultDetectEnable, nidaqmx), int32, (TaskHandle, Ref{UInt8}), taskHandle, channel)
end

function DAQmxGetAIOvercurrentDetectEnable(taskHandle, channel, data)
    ccall((:DAQmxGetAIOvercurrentDetectEnable, nidaqmx), int32, (TaskHandle, Ref{UInt8}, Ref{bool32}), taskHandle, channel, data)
end

function DAQmxSetAIOvercurrentDetectEnable(taskHandle, channel, data)
    ccall((:DAQmxSetAIOvercurrentDetectEnable, nidaqmx), int32, (TaskHandle, Ref{UInt8}, bool32), taskHandle, channel, data)
end

function DAQmxResetAIOvercurrentDetectEnable(taskHandle, channel)
    ccall((:DAQmxResetAIOvercurrentDetectEnable, nidaqmx), int32, (TaskHandle, Ref{UInt8}), taskHandle, channel)
end
...
function DAQmxGetReadInputLimitsFaultChansExist(taskHandle, data)
    ccall((:DAQmxGetReadInputLimitsFaultChansExist, nidaqmx), int32, (TaskHandle, Ref{bool32}), taskHandle, data)
end
...
function DAQmxGetReadPowerSupplyFaultChansExist(taskHandle, data)
    ccall((:DAQmxGetReadPowerSupplyFaultChansExist, nidaqmx), int32, (TaskHandle, Ref{bool32}), taskHandle, data)
end
...
function DAQmxGetFirstSampClkOffset(taskHandle, data)
    ccall((:DAQmxGetFirstSampClkOffset, nidaqmx), int32, (TaskHandle, Ref{float64}), taskHandle, data)
end
